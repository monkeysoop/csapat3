...
```
cd existing_repo
git remote add origin https://szofttech.inf.elte.hu/szofttech-ab-2024/group-07/csapat3.git
git branch -M master
...
- [ ] [Set up project integrations](https://szofttech.inf.elte.hu/szofttech-ab-2024/group-07/csapat3/-/settings/integrations)
