...
public class PersistenceTests
{
    ...
    public void LogReadTest()
    {
        Assert.Multiple(async () =>
        {
            ...
            var log = await logFileDataAccess.Load("../../../../MekkdonaldsWPF/samples/random_20_log.json");
            ...
            log = await logFileDataAccess.Load("../../../../MekkdonaldsWPF/samples/warehouse_100_log.json");
    ...
    public async Task LogWriteTest()
    {
        ...
        await logFileDataAccess.Save("./test_log.json", log);

        log = await logFileDataAccess.Load("./test_log.json");
